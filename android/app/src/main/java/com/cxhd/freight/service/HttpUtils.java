package com.cxhd.freight.service;
    ...
    public static String performPostRequest(String baseUrl, Map<String, String> params) {
        ...
        try {
            ...
            if (null != url) {
                ...
                connection.setRequestProperty(HEADER_CONTENT_TYPE, getBodyContentType());
                if (null != data) {
                ...
                if (200 == responseCode) {
                    result = getResultString(connection.getInputStream(),getParamsEncoding());
                    //Log.d(LOG_TAG,"responseOK:" + responseCode);
                }
                else {
                    //Log.e(LOG_TAG, "Connection failed: " + connection.getResponseCode());
                }
            }
        }
        catch (MalformedURLException e) {
